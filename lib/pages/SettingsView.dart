...
class _SettingsViewState extends State<SettingsView> {
  ...
  Future<TimeOfDay?> selectTimeDialog(BuildContext context) async {
    ...
    TimeOfDay initTime = TimeOfDay(hour: 18, minute: 0);
          ...
          SettingsGroup(
            ...
            children: <Widget>[
              ...
              DropDownSettingsTile<int>(
                title: 'NoScreen time start',
                subtitle:
                    'Choose the duration of screen-free time before sleep',
                settingKey: 'noscreen-time-start',
                values: <int, String>{
                  15: '15min prior',
                  30: '30min prior',
                  60: '1 hour prior',
                ...
                selected: 60,
                onChange: (value) {
                  debugPrint('noscreen-time-start: $value');
                },
              ),
              TextInputSettingsTile(
                title: 'NoScreen time duration',
                settingKey: 'noscreen-time-duration',
                initialValue: '6',
                ...
                onChange: (value) {
                  debugPrint('noscreen-time-duration: $value');
                },
              ),
            ],
          ),
